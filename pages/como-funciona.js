...
export default function ComoFunciona() {
  return (
      <>
        <Head>
          <title>Coop - Cómo funciona</title>
        </Head>
        <Banner title={"Comprometidos con la salud"} backImage={"/images/banner-como-funciona.jpg"} cta={{url: '/solicita-demo', text: 'Solicita una demo'}}>
