  ...
  return (
      <>
        ...
        <section className="titleContent">
          ...
          <h5>Compromiso</h5>
          <p>Estamos totalmente comprometidos con GDPR y hemos publicado actualizaciones de nuestra <Link href={"/politica-de-privacidad"}><a>Política de privacidad</a></Link> y <Link href={"/terminos-de-uso"}><a>Términos de uso</a></Link>. Los cambios reflejan el aumento de los requisitos de transparencia del GDPR.</p>
