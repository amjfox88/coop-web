...
export default function SmartHealthCoach() {
  return (
      <>
        <Head>
          <title>Coop - Smart Health Coach</title>
        </Head>
        <Banner title={"La AI que cuida y acompaña al empleado"} backImage={"/images/banner-smart-health-coach.jpg"}/>
